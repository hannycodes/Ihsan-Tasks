...
export default function Footer() {
  return (
    <footer className="bg-[#DDF6D2] text-[#3E5C3B] py-12 px-8 font-serif">
      <div className="flex flex-col items-center gap-8">
        {/* Brand */}
        <div className="text-center">
          <h3 className="font-playfair text-2xl text-[#3E5C3B] mb-2.5">
            IHSAN TASKS
          </h3>
        ...
        <div className="flex gap-4">
          <a href="#" aria-label="Instagram" className="transform hover:scale-110 transition-transform">
            <svg xmlns="http://www.w3.org/2000/svg" fill="#3E5C3B" width="24" height="24" viewBox="0 0 24 24">
      ...
      <div className="text-center text-sm mt-8 text-[#3E5C3B]">
